...
scale-correlation tables in the other ablation scripts.
...
Usage:
    python ablation/sqnr_per_layer.py --model meta-llama/Llama-3.2-1B
    python ablation/sqnr_per_layer.py --model Qwen/Qwen3-0.6B --nsamples 2
    python ablation/sqnr_per_layer.py --model meta-llama/Llama-3.2-1B \\
